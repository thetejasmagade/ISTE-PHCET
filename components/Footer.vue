<template>
  ...
  <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    <a class="flex title-font font-medium items-center md:justify-start justify-center text-white">
      ...
      <span class="ml-3 text-2xl font-semibold">ISTE PHCET</span>
    </a>
    <div class="block text-white py-8 md:py-0">
  ...
  methods: {
    navClass() {
      if ($nuxt.$route.name == "index") {
        this.activeMenuForHome = "active text-red-500 font-semibold";
        ...
        this.activeMenuForAbout = "active text-red-500 font-semibold";
        this.activeMenuForOutcomes = "";
        this.activeMenuForEvents = "";
        this.activeMenuForLogin = "";
        ...
        this.activeMenuForHome = "";
        this.activeMenuForAbout = "";
        this.activeMenuForOutcomes = "active text-red-500 font-semibold";
        this.activeMenuForEvents = "";
        this.activeMenuForLogin = "";
        ...
        this.activeMenuForAbout = "";
        this.activeMenuForOutcomes = "";
        this.activeMenuForEvents = "active text-red-500 font-semibold";
        this.activeMenuForLogin = "";
        ...
        this.activeMenuForOutcomes = "";
        this.activeMenuForEvents = "";
        this.activeMenuForLogin = "active text-red-500 font-semibold";
      }
    },
  },
}
